...
```
## Multiple regression
If we would like to study the factors affecting the sleep, we could run a multiple linear regression. The following analysis reveals how much the time spent at work, with family or at shopping is related with hours spent in sleep :
```{r}
